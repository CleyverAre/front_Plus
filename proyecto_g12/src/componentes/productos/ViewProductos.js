    ...
    return(
        <div className = 'border-b p-5 flex justify-between items-center'>
            <div className= 'flex flex-col items-start'>
                ...
                <p className = 'mb-1 text-sm text-gray-50 uppercase'>descrpcion:{descripcion}</p>
                <p className = 'mb-1 text-gray-50'>stock:{stock}</p>
                <p className = 'mb-1 text-x1 text-gray-50'>precio:{precio}</p>
                <img src= {imagen} width ="150" heigth = "150"
                ></img>
            ...
            <button
                ...
                //onClick={() => handkeModalEditarTarea(tarea)}
                >Editar</button>

                <button
                className="bg-red-600 px-4 py-3 text-white uppercase font-bold text-sm rounded-lg"
                //onClick={() => handkeModalEliminarTarea(tarea)}
                >Eliminar</button>
